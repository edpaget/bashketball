...
-- Create the combined authorization table
...
CREATE INDEX idx_authorization_actor_id ON authorization(actor_id);
-- Index for lookups by identity
CREATE INDEX idx_authorization_identity ON authorization(provider, provider_identity);
